...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	public static boolean isEmpty(String value) {
		if (null != value && !value.equals("null") && !value.trim().isEmpty()) {
			return false;
		}
		return true;
	}
	 ...
	 * @throws Exception
	 */
	private static boolean isRealIPAddr(String ipAddr) {
		boolean b1 = false;
	 ...
	 * @return
	 */
	public static String createCode(String beginStr) {
		String value = "";
		value += beginStr + value + DateUtils.getDate("yyyyMMddHHmmssSSS");
		return value;
	}
}
